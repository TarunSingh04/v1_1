...
import ElearningLogo from "../../assets/elearningLogo.svg";
  ...
  return (
    <div className={styles.Marketplace}>
      ...
      <div className={styles.marketPlacecont}>
          <Image src={ElearningLogo} width={190} height={160} alt='none' className={styles.dateIcon}/>
          <p className={styles.Headline}>E-learning Coming Soon!</p>
      ...
      </div>
      {
        ...
        <div className={styles.boxCont}>
          <div className={styles.subBox}>
            ...
            You&apos;re subscribed to E-learning!
            </p>
          </div>
